...
IBM Cloudダッシュボードの右上のアカウント情報が変更されたことを確認し、左側メニューバーの[リソースリスト]をクリックします。
![](./images/006.png)
...
### 2.2 リポジトリーのFork
ブラウザーで[https://github.com/kazuya-hodatsu-336-1/BlazorSample2](https://github.com/kazuya-hodatsu-336-1/BlazorSample)を開いてください。<br>
...
今回デプロイする対象のアプリケーションはGitHubリポジトリー[BlazorSample2]の「Server」ディレクトリ配下のため、ここでディレクトリを指定します。
![](./images/015.png)

### 3.4 デプロイするアプリケーションのタイプを選択
言語やタイプの一覧がタイルで表示され、.NETが選択されていることを確認します。<br>
ビルダーイメージのバージョンは[3.1-el7]を選択してください。<br>
...
変更点をクイックに確認するために、ここでは3行目の英文「Hello, world」を日本語の「こんにちは」に変更してみます。<br>
